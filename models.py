...
class Category(models.Model):
	...
	catdesc_text = models.CharField(max_length=200, null=True, blank=True, help_text="Use puns liberally")
...
class Reminder(models.Model):
	...
	remdesc_text = models.CharField(max_length=200, null=True, blank=True, help_text="Use puns liberally")
